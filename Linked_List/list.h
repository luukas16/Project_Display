...
struct List_s{
    ...
    enum ListOutOfBounds state_of_current;

    //variable only to be used by the head of a list
    int list_length;
};



static struct Node_bank nodePool;
struct Node_bank{
    // TODO: You should change this!
    //creating storage for the nodes
    struct Node_s node_array[LIST_MAX_NUM_NODES];
    struct Node_s head_array[LIST_MAX_NUM_HEADS];
};
